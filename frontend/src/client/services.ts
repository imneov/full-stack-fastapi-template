...
export class SecretsService {
   ...
   * @throws ApiError
   */
  public static readSecret(
    data: SecretsData["ReadSecret"],
  ): CancelablePromise<SecretPublic> {
    const { id } = data
    return __request(OpenAPI, {
      method: "GET",
